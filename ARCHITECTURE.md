...
- `REPORT_REDIRECT` — ส่งรายงานของกลุ่มต้นทางไปเข้ากลุ่มปลายทางแทน (เนื้อหายังเป็นของต้นทาง); ครอบ **รายงานสลิป 00:30 + สรุปหนี้** แต่ **ไม่ครอบสรุปจอง** (สรุปจองอยู่กลุ่มของมันเองเสมอ); รูปแบบ `ต้นทาง:ปลายทาง,ต้นทาง2:ปลายทาง2`
...
- **แก้ logic การเงินเมื่อไร ให้รันเทสต์ก่อน push เสมอ** (เคสพวกนี้ตาเปล่าไม่เห็น)
