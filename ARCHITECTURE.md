...
- **B. จองโต๊ะ** — AI จับข้อความจอง → การ์ดปุ่มคอนเฟิร์ม, จองล่วงหน้าส่งกลุ่มบาร์น้ำ, เตือนซ้ำจนคอนเฟิร์ม, สรุปจอง (วันนี้+ล่วงหน้า) 16:00
...
- `maybe_send_resv_summary` — กรอบ 16:00–18:59 วันละครั้ง: สรุปจอง 'วันนี้ + ล่วงหน้า' (upcoming) → BAR_GROUP + RESV_GROUPS; ไม่มีจอง=ไม่ส่ง
