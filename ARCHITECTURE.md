...
- กระทบบิล-สลิป (เฉพาะ DINING_GROUPS): ส่งรูปบิลร้าน+สลิป (AI แยกเอง) • `ยอดสะสม`/`ยอดทริป` (ดูยอด+รายการโอนขาด) • `เก็บครบแล้ว`/`ปิดยอด` (ยืนยันเก็บเงินครบ → รีเซ็ตยอดทริปเป็น 0)
