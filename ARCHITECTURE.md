...
- `RESV_NAG_MAX_HOURS`(6), `RESV_SUMMARY_HOUR`(11 = เวลาส่งสรุปจองวันนี้อัตโนมัติ), `RESV_REPORT_DAYS`(7), `RESV_KEEP_DAYS`(15), `MISS_KEEP_DAYS`(14), `SLIP_KEEP_DAYS`(60), `SLIP_WORKERS`(2)
