...
- 🔴 **ค่าใช้จ่าย/กำไร ในสรุปรายวัน+รายสัปดาห์ผิด — ใบจ่ายเงินครอบ 1 สัปดาห์ ถูกนับ 7 รอบ**
  `findLatestPdf_('PayoutReport')` ไม่เช็ควันเทียบกับใบขายเลย · และเส้นทางกลางคืนไม่เรียก `_rangeWarn_(pt)`
  ทั้งที่เส้นทางกู้ย้อนหลังเรียก → **ยังไม่แก้** · รายละเอียด+ทางแก้ครบอยู่ที่ `HANDOFF.md` §3.12
